...
<link rel="stylesheet"
	href="assets/font-awesome/css/login/font-awesome.min.css">
...
<body>
	...
	<div class="container">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.html">Bootstrap Registration
				Form Template</a>
		</div>
		<!-- Collect the nav links, forms, and other content for toggling -->
		<div class="collapse navbar-collapse" id="top-navbar-1">
			<ul class="nav navbar-nav navbar-right">
				<li><span class="li-text"> 欢迎使用信息关系后台系统，请填写登录信息 </span> <!--<a href="#"><strong>links</strong></a> -->
					<!--<span class="li-text">--> <!--here, or some icons: --> <!--</span> -->
					<!--<span class="li-social">--> <!--<a href="#"><i class="fa fa-facebook"></i></a> -->
					<!--<a href="#"><i class="fa fa-twitter"></i></a> --> <!--<a href="#"><i class="fa fa-envelope"></i></a> -->
					<!--<a href="#"><i class="fa fa-skype"></i></a>--> <!--</span>--></li>
			</ul>
		</div>
	</div>
	</nav>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-8 col-sm-offset-2 text" style="padding: 25px">
						<h1>
							<strong>登录</strong> 信息管理系统
						</h1>
						<div class="description">
							<p>
								期待是一种半清醒半疯狂的燃烧，使焦灼的灵魂幻觉自己生活在未来。<br /> <strong>别特么瞎想了，敲代码吧</strong>
							</p>
						</div>
					</div>
				</div>
